...
// * Copyright © 2016 MOOG Animatics Corp.
// ************************************************************************************************
#pragma once

#define MAX_STRLEN				256
#define MAX_HOST_AXIS			12
#define PI						((double)3.14159265358979323846)
#define EPSILON					0.0000000001

#define MAX_PRG_LENGTH			0x00007FFF
#define MAX_PRG_LEN_CL4TP		0x0000F000
#define MAX_PRG_LENGTH9			0x0000FFFE
#define MAX_PRG_LENGTH6			0x0000FA96
#define MAX_PRG_LENGTH6_1X		0x00004800 // 0x3000 addresses * 3/2
...
#define	CMA_USESELECTEDADAPTER	0x08000000	// if more then one adapter set the 

// only internal so decided to use same value for use selected IP adapter
...
#define EID_OPEN_LANGFILE			4056
#define EID_INVALID_PROJ			4057
#define EID_READFILE_PROJ			4058
#define EID_CHANGEBAUD				4059	
#define EID_CANERROR				4060
#define EID_NOCANDWLD				4061	
#define EID_ACKNOTRECEIVED			4062
#define EID_NOMODBUSDWLD			4063	
#define EID_INCORRECTFIRMWARE		4064
#define EID_FIRMFILEFORMAT			4065
#define EID_FIRMBUFFEREXCEED		4066
#define EID_FIRMCHECKSUM			4067
#define EID_FIRMADDRESS				4068
#define EID_FIRMTYPE				4069
#define EID_FIRMDATAINSERT			4070
#define EID_CMDNOSUPPORT			4071	
#define EID_NOTIMEDELTA				4072		
#define EID_SETINVALIDTIME			4073	
#define EID_VOLTAGEFAULT			4074	
#define EID_EXCESSIVETEMP  			4075	
#define EID_EXCESSIVEPOS   			4076	
#define EID_VELOCITYLIMIT			4077	
#define EID_DEDTLIMIT   			4078	
#define EID_HWPOSLIMIT  			4079	
#define EID_HWNEGLIMIT 				4080	
#define EID_SWPOSLIMIT  			4081	
#define EID_SWNEGLIMIT  			4082	
#define EID_FIRMVERMISSMATCH		4083
#define EID_BADMODEL				4084
#define EID_DRVNOTREADY				4085		
...
#define WR_PRINTTOOLONG				8815

#define FER_2MANYERRORS				8900
#define FER_2MANYWARNINGS			8901
#define FER_NESTING					8902

// warning range
#define IS_WARNING_ID(x)	(((x) >= WR_BAUDRATE) && ((x) <= (WR_BAUDRATE + 99)))

// fatal error range (stop scanning)
#define IS_FATAL_ID(x)		(((x) >= FER_2MANYERRORS) && ((x) <= (FER_2MANYERRORS + 99)))

// ************************************************************************************************
// used when warnings replaces errors for keywords (no strings associated) only used for ER_UNDEFINED
#define ERRTOWARN_START		(FER_2MANYERRORS + 100)									// set start area of converted errors 9000
